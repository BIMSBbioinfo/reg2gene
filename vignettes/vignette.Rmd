...
__Model voting by voteAssociations()__
...
running __voteAssociations()__ as follows:


voteAssociations( associations=associations, 
                  cutoff.stat="pval",
                  cutoff.val=0.05,
                  vote.threshold=0.5)
...
__Meta-analysis using metaAssociations()__
...
One runs meta-analysis using __metaAssociations()__ to combine association
...
and weigthed averaging respectively as follows:
 ...
 metaAssociations(associations = associations)
...
## Benchmarking enhancer-gene associations using benchmarkAssociations()__
...
## Assessing modelling performance using confusionMatrix()__
...
## Visualizing enhancer-gene associations using plotGenomeInteractions()__
...
__plotGenomeInteractions()__ as follows (FTO/IRX3/IRX5 region example)
...
regions reported in the interactionData input objects, whereas it only needs
...
## Annotating regulatory regions to genes using annotateGenomicRegions()__
...
GRanges object using __annotateGenomicRegions()__ as follows:
